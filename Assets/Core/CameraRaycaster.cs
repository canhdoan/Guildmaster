...
namespace Guildmaster.Core
{
    public class CameraRaycaster : MonoBehaviour
    {
        ...
        public delegate void OnCursorLayerChange(RaycastHit raycastHit, int newLayer); // declare new delegate type
        ...
        void Update()
        {
            ...
            {
                NotifyObserversIfLayerChanged(priorityHit.Value, 0); // broadcast default layer
                return;
            }

            // Notify delegates of layer change
            var layerHit = priorityHit.Value.collider.gameObject.layer;
            NotifyObserversIfLayerChanged(priorityHit.Value, layerHit);
            ...
            // Update the publicly accessible Layer Hit variable
            raycastHit = priorityHit.Value;
        }

        void NotifyObserversIfLayerChanged(RaycastHit raycastHit, int newLayer)
        {
